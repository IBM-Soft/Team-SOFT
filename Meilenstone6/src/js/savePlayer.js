...
function savePlayer(){
    ...
    if (checkPlayer()) {
        ...
        var player = {};
        player["vorname"] = document.getElementById("vorname").value;
        player["name"] = document.getElementById("name").value;
        player["verein"] = document.getElementById("verein").value;
        player["hcoach"] = document.getElementById("hcoach").value;
        player["acoach"] = document.getElementById("acoach").value;
        player["number"] = document.getElementById("number").value;
        player["jahr"] = document.getElementById("jahr").value;
        ...
        xmlhttp.open("PUT", URL_SAVE_PLAYER, true);
